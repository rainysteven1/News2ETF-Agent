...
def mock_config() -> MagicMock:
    ...
    config = MagicMock()
    config.data.industry_dict = MagicMock()
    config.data.etf_info = MagicMock()
    config.data.etf_info.parent = MagicMock()
    config.data.etf_info.parent.parent = MagicMock()
    config.data.etf_info.parent.parent.parent = MagicMock()
    return config
