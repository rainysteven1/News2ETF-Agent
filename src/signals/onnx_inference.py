...
class ONNXInferencePipeline:
    ...
    def __init__(self, config: AgentRootConfig) -> None:
        ...
        self._finbert_sess: ort.InferenceSession | None = None
        self._finbert_tokenizer: AutoTokenizer | None = None
        self._setfit_sessions: dict[str, ort.InferenceSession] = {}
        self._setfit_tokenizers: dict[str, AutoTokenizer] = {}
